        ...
        return (
            <div className="flex flex-col items-center justify-center h-screen bg-background text-foreground p-4 relative overflow-hidden">
                ...
                <motion.div
                    ...
                    className="bg-card/60 dark:bg-card/30 p-8 rounded-3xl border border-border/50 dark:border-white/10 backdrop-blur-xl max-w-md w-full text-center space-y-6 shadow-2xl relative z-10"
                >
                    <motion.div
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4">
                        <Link href="/login" className="w-full">
                            <Button variant="outline" className="w-full h-12 text-base transition-all">
                                Sign In
                            </Button>
                        </Link>
                        <Link href="/signup" className="w-full">
                            <Button className="w-full h-12 text-base transition-all">
                                Sign Up
                            </Button>
                        </Link>
                    </div>

                    <Link href="/" className="inline-block mt-4 text-sm text-muted-foreground hover:text-primary transition-colors border-b border-transparent hover:border-primary/40 pb-0.5">
                        Return to Home Page
                    </Link>
                </motion.div>
            </div>
